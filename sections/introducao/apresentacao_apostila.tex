% sections/introducao/apresentacao_apostila.tex
% !TeX root = ../../main.tex
...
principais ferramentas \gls{online} e gratuitas do Google \Gls{workspace}. Além de 
...
\begin{itemize}
    ...
    também apresentou a relevância das ferramentas digitais ao indicar que \textbf{7,4 
    milhões de brasileiros estavam trabalhando por meios remotos (home office) 
    no ano de 2022}.
    
    \item Segundo a Pesquisa de Inovação Semestral 2022 do IBGE (2023), \textbf{a computação em 
    \gls{nuvem} é a tecnologia avançada mais adotada entre as empresas brasileiras}, 
    ...
    \gls{nuvem}, como o Google \Gls{workspace}, são as mais utilizadas no mercado de trabalho, 
    visto que são soluções acessíveis, colaborativas e produtivas. 
\end{itemize}

Com isso, nosso intuito é contribuir para que cada vez mais pessoas tenham acesso ao 
conhecimento básico digital, as capacitando com autonomia para realizarem suas tarefas 
digitais com cada vez mais facilidade e segurança! 