...
A ferramenta permite a pesquisa digitando qualquer termo na \gls{barrapesquisa}, porém, para melhor utilizar o poder dela, é necessário aprender sobre os operadores de pesquisa. Eles são termos específicos que, ao serem digitados, permitem alterar o comportamento da ferramenta como um todo, podendo aumentar a precisão dos resultados.
...
Perceba na figura \ref{fig:operadores1}, como os resultados apresentam variações da palavra “desenhada”, porém, não apresentam ela nos títulos dos tópicos encontrados. Já na figura \ref{fig:operadores2} é possível perceber que a palavra está presente nos títulos das páginas dos resultados.
...
Um detalhe importante a se observar é o formato que a data foi colocada. Na pesquisa foi utilizado a seguinte formatação: 2025-08-01. Este formato de data é o formato da ISO 8601, ele especifica que a formatação deve seguir a seguinte ordem: ano, mês e dia separados por hífen.
...
\begin{tabular}{>{\ttfamily}p{3cm} p{6cm} p{5cm}}
		...
		\addlinespace
		filetype & Pesquisa pelo tipo de documento & filetype:\gls{pdf} \\
		\addlinespace
		...
		\addlinespace
		inurl & Pesquisa pelo termo presente na \gls{url} & inurl:farroupilha \\
		\addlinespace
