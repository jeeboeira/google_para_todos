...
\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{/slides/slide/Imagem 3.png}
    \caption{}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{/slides/slide/Imagem 4.png}
    \caption{}
\end{figure}

\begin{dica}
    Nesta mesma guia, você pode clicar sobre o botão “Importar tema” para adicionar um novo padrão de slides em sua apresentação. Basta procurar e selecionar o arquivo de slides baixado em nuvem ou no seu computador através da janela de busca.
\end{dica}
