...
\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{images/slides/slide/Imagem 1.png}
    \caption{Aplicar layout}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Transições disponíveis}
\end{figure}
