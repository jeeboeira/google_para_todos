...
\begin{figure}[H]
    \centering
    \includegraphics[width=.55\textwidth]{/slides/editar/Imagem 1.png}
    \caption{Aba Editar}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.65\textwidth]{/slides/editar/Imagem 2.png}
    \caption{Janela popup Localizar e Substituir}
\end{figure}
