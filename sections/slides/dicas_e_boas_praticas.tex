...
\begin{table}[H]
  ...
  \begin{tabular}{@{}lll@{}}
    ...
    \midrule
      ...
      Iniciar apresentação do \gls{slide} atual & Ctrl + Shift + F5 & \cmd + Enter \\
      Sair da apresentação & Esc & Esc \\
      Avançar/voltar \gls{slide} & → / ← ou Page Down / Up & → / ← ou Page Down / Up \\
...
\begin{itemize}
  ...
  \item Escreva pouco texto em cada \gls{slide}: destaque apenas os pontos principais. Busque abordar detalhes e explicações em sua fala, tornando a leitura menos cansativa;
