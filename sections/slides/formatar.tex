...
\begin{itemize}
    ...
    \textit{Dica: você pode utilizar o atalho \tecla{CTRL + .} para sobrescrever um texto}
    ...
    \textit{Dica: você pode utilizar o atalho \tecla{CTRL + ,} para subscrever um texto}
...
\textit{Dica: ao escrever os itens de uma lista, se você pressionar a tecla \tecla{Tab}, irá criar uma sub lista. Utilize \tecla{Shift + Tab} para retornar a lista hierarquicamente superior.}
