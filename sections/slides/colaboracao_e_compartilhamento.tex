...
Ao acessar o menu ``Arquivo'', clique em uma das opções presentes na guia ``Compartilhar''. Após dar um nome ao seu projeto ou apresentação, você pode esolher entre duas funções específicas de compartilhamento: uma que direciona para usuários e outra para a web.
