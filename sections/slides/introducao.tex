...
O Google Apresentações é uma ferramenta digital gratuita do \textbf{Google}, cuja finalidade é a elaboração, edição e compartilhamento de apresentações em \textbf{slides}. Por se tratar de uma ferramenta \textbf{\gls{online}}, podemos acessar os conteúdos criados através de outros dispositivos, mesmo estando em diferentes lugares. Isso é essencial para o trabalho em grupo, uma vez que os integrantes podem interagir e realizar alterações simultâneas em um mesmo \gls{arquivo} remotamente.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.8\textwidth]{/slides/introducao/Imagem 1.png}
  \caption{Criar um projeto}
\end{figure}
...
%   \caption{Criar um projeto - Projeto em branco}
% \end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.9\textwidth]{/slides/introducao/Imagem 3.png}
  \caption{Criar um projeto - Barra de ferramentas}
\end{figure}
...
Para abrir um \gls{arquivo} já existente salvo em \gls{nuvem} (\textbf{Google Drive}, por exemplo) ou no dispositivo local, selecione a guia ``\Gls{arquivo}'' e clique sobre a opção ``Abrir''.

\begin{figure}[H]
  \centering
  \includegraphics[width=.39\textwidth]{/slides/introducao/Imagem 4.png}
  \caption{Menu arquivo em foco opção “Abrir”}
\end{figure}

E então, escolha o \gls{arquivo} que deseja abrir:

\begin{figure}[H]
  \centering
  \includegraphics[width=.9\textwidth]{/slides/introducao/Imagem 5.png}
  \caption{Aba Meu Drive}
\end{figure}

\begin{dica}
  Você pode alterar o local e a forma de busca selecionando os itens de pesquisa na barra superior: ``Meu Drive'', ``Compartilhados comigo'', ``Com estrela'', ``Computadores'' ou ``\Gls{upload}''
\end{dica}
...
Para importar slides de outros arquivos, selecione a opção ``Importar slides'', na \gls{aba} ``\Gls{arquivo}'' do menu superior principal, conforme ilustrado na imagem:

\begin{figure}[H]
  \centering
  \includegraphics[width=.39\textwidth]{/slides/introducao/Imagem 6.png}
  \caption{Menu Arquivo em foco opção “Importar Slides”}
\end{figure}

Selecione o ícone do \gls{arquivo} que deseja abrir (alterne a seleção entre as abas de busca para procurar arquivos em outros locais).

\begin{figure}[H]
  \centering
  \includegraphics[width=.7\textwidth]{/slides/introducao/Imagem 7.png}
  \caption{Importar Slides}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=.7\textwidth]{/slides/introducao/Imagem 8.png}
  \caption{Janela Windows}
\end{figure}
