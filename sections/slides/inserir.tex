...
\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{images/slides/inserir/Imagem 1.png}
...
Permite adicionar vídeos ao \gls{slide}. Podem ser importados através de uma pesquisa direta no YouTube, via \gls{url} (\gls{link} de um vídeo da internet) ou Google Drive (vídeo salvo em \gls{nuvem} na sua conta Google).
