...
\begin{dica}
  No modo ``Apresentação de slides'', em tela cheia, aperte \tecla{L} para transformar o cursor do \textbf{mouse} em uma ferramenta visual semelhante a um laser, útil para destacar figuras, gráficos ou textos importantes.
\end{dica}
