...
A opção ``Mostrar sugestões de ortografia'' controla se as sugestões aparecerão automaticamente em um pequeno \textbf{popup} acima da palavra incorreta. Se a opção já estiver ativada, será exibido um ícone de verificação ao lado da palavra incorreta.
...
Ao inserir, por exemplo, um \textbf{gráfico vinculado a uma planilha}, o objeto permanece conectado ao arquivo original do Google Planilhas. Assim, qualquer \textbf{edição feita na planilha} será \textbf{atualizada automaticamente} na apresentação. 
Caso o arquivo esteja aberto em uma guia do navegador e alguma alteração seja realizada, é necessário clicar sobre o gráfico inserido e selecionar \textbf{``Atualizar''} para sincronizar os dados.
