...
\begin{figure}[H]
	...
	\caption{ Tela inicial do Google Formulários, exibindo as opções para iniciar um formulário em branco ou usar modelos pré-formatados ("Teste em branco," "Avaliação do curso").}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{images/forms/criacao_de_formularios/Imagem 2.png}
	\caption{Exemplo de um formulário já estruturado ("Convite para festa") na aba "Perguntas", mostrando a aplicação de questões de Resposta Curta e Múltipla Escolha.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{images/forms/criacao_de_formularios/Imagem 3.png}
	\caption{Visualização de um formulário novo ("Teste em branco"), destacando a área de edição para o título e a descrição do formulário.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.4\textwidth]{images/forms/criacao_de_formularios/Imagem 4.png}
	\caption{Menu suspenso que cataloga a variedade de tipos de pergunta disponíveis, como ''Resposta curta'', ''Múltipla escolha'', ''Escala linear'' e ''Classificação''.}
\end{figure}
