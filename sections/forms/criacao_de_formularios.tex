...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{images/forms/criacao_de_formularios/Imagem 1.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.26\textwidth]{images/forms/criacao_de_formularios/Imagem 4.png}
\end{figure}
