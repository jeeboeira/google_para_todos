...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/configuracoes_do_formulario/Imagem 8.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/configuracoes_do_formulario/Imagem 10.png}
\end{figure}
