...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/configuracoes_do_formulario/Imagem 7.png}
	\caption{Menu principal de configurações do formulário, destacando as opções para coleta de endereços de e-mail.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Configurações de respostas, mostrando opções para coleta de e-mails, envio de cópias e edição de respostas.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/configuracoes_do_formulario/Imagem 9.png}
	\caption{Visão geral das abas de configurações disponíveis: criar teste, gerenciar respostas e configurações de apresentação.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Configurações de apresentação do formulário, incluindo barra de progresso e embaralhamento de perguntas.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/configuracoes_do_formulario/Imagem 11.png}
	\caption{Configurações avançadas para testes, incluindo liberação de notas e modo bloqueado para Chromebooks.}
\end{figure}
