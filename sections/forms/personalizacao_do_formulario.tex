...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/personalizacao_do_formulario/Imagem 1.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/personalizacao_do_formulario/Imagem 2.png}
\end{figure}
