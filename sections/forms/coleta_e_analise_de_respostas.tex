...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 1.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 2.png}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 3.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 4.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 5.png}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 6.png}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.9\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 7.png}
\end{figure}
