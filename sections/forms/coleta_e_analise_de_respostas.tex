...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 1.png}
	\caption{Tela inicial do Google Forms mostrando o menu de navegação entre as abas de respostas.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 2.png}
	\caption{Visão da aba de resumo das respostas, destacando o link de integração com o Google Planilhas.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 3.png}
	\caption{Detalhamento individual de uma resposta recebida no formulário, mostrando a pergunta e as opções.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 4.png}
	\caption{Menu de opções de resposta, com destaque para a funcionalidade "Link para as Planilhas".}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 5.png}
	\caption{Janela de configuração para selecionar o destino das respostas no Google Planilhas.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 6.png}
	\caption{Planilha do Google Sheets criada para receber e armazenar as respostas do formulário.}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.8\textwidth]{images/forms/coleta_e_analise_de_respostas/Imagem 7.png}
	\caption{Gráfico de pizza gerado automaticamente, mostrando a distribuição percentual das respostas.}
\end{figure}
