...
\begin{figure}[H]
	...
	\caption{Janela de confirmação de publicação do formulário, mostrando o link público para acesso dos participantes.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Tela de compartilhamento do formulário por e-mail, com opção para enviar notificação aos destinatários.}
\end{figure}
...
Podem ser alteradas através do botão textcompartilhar (ícone de ``perfil e
...
\begin{figure}[H]
	...
	\caption{Menu de configurações de compartilhamento, mostrando diferentes níveis de permissão (participante, editor) e opções adicionais.}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Menu de opções adicionais do formulário, incluindo funções como fazer cópia, incorporar HTML e cancelar publicação.}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{images/forms/compartilhamento_do_formulario/Imagem 16.png}
	\caption{Janela para incorporar o formulário em sites via código HTML, com campos para ajustar largura e altura.}
\end{figure}
