...
através do link \href{https://docs.google.com/}{https://docs.google.com/}, você precisará realizar o login na sua conta Google e já 
terá acesso à página com alguns modelos de documentos pré-prontos. 

\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{images/documentos/introducao_documentos/Imagem9.png}
    \caption{}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{images/documentos/introducao_documentos/Imagem10.png}
    \caption{}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{images/documentos/introducao_documentos/Imagem11.png}
    \caption{}
\end{figure}
...
\begin{enumerate}
    \item Clicar sobre o menu \textbf{Ver};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{images/documentos/introducao_documentos/Imagem12.png}
    \caption{}
\end{figure}