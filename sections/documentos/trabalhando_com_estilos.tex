...
\begin{enumerate}
    \item Para numerar as páginas do seu documento, abra o menu Formatar e selecione a opção “Números de página”. A tela de configuração de numeração de páginas será aberta.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/documentos/trabalhando_com_estilos/pt3/Imagem1.png}
    \caption{}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/documentos/trabalhando_com_estilos/pt3/Imagem2.png}
    \caption{}
\end{figure}


\subsection{Função limpar formatação}
Utilizada para remover os estilos que foram aplicados no trecho. Irá remover a cor, o tamanho, formatação em negrito e/ou itálico, por exemplo. A estilização retorna ao estilo padrão do documento.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/documentos/trabalhando_com_estilos/pt3/Imagem3.png}
    \caption{}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/documentos/trabalhando_com_estilos/pt3/Imagem7.png}
    \caption{}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/documentos/trabalhando_com_estilos/pt3/Imagem8.png}
    \caption{}
\end{figure}