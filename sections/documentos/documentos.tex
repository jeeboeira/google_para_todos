...
mantida pela Google, seu uso é \gls{online} e gratuito à todos os usuários de contas 
Google. O acesso à plataforma é realizado por qualquer navegador (Google Chrome,
 Microsoft Edge, Safari, etc…) através do \gls{link} 
 \hyperlink{https://docs.google.com/}{https://docs.google.com/}, você precisará 
realizar o \gls{login} na sua conta Google e já terá acesso à página com alguns 
modelos de documentos pré-prontos. 

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{/documentos/introducao_documentos/Imagem10.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/documentos/introducao_documentos/Imagem10.png}
    \caption{}
\end{figure}
...
\subsubsection{Título do \gls{arquivo}}
O título do \gls{arquivo} fica no canto superior esquerdo da página. Para renomeá-lo é 
só clicar no campo e escrever o novo título.

\subsubsection{Menus}
Os menus ficam localizados logo abaixo do título do \gls{arquivo}. As opções são: 
“\Gls{arquivo}”, “Editar”, “Ver”, “Inserir”, “Formatar”, “Ferramentas”, “Extensões” e 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/documentos/introducao_documentos/Imagem11.png}
    \caption{}
\end{figure}


\subsubsection{Página}
A página do \gls{arquivo} é o grande campo branco, nele você conseguirá construir o 
seu \gls{arquivo}. Ela fica no centro da tela, é só clicar com o mouse e começar a 
escrever.
...
linha que está com o \gls{cursor}.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/documentos/introducao_documentos/Imagem12.png}
    \caption{}
\end{figure}
