...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/documentos/menu_ferramentas/pt2/Imagem13.png}
    \caption{}
\end{figure}
...
\paragraph{A partir desse ponto, você pode configurar a numeração das linhas como desejar:}
