...
\begin{figure}[H]
    ...
    \caption{Menu de “Ferramentas” aberto com a opção “Ortografia e Gramática” selecionada}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Modal que permite aceitar ou rejeitar as correções sugeridas}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Menu de correção rápida do texto}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Menu com opções mais complexas de correção}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Tela de dicionário pessoal com a palavra “exempo” adicionada}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Exemplo de uma lista com subitens e alguns itens marcados como concluídos}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Exemplo de uma lista estilizada com diferentes ícones (setas, quadrados, pontos, etc.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Exemplo de uma lista com diferentes estilos de numeração (número com ponto, número com parênteses e números romanos}
\end{figure}