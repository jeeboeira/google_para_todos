...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/documentos/status_do_documento_e_uso_offline/Imagem1.png}
    \caption{Habilitando documento para uso offline}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/documentos/status_do_documento_e_uso_offline/Imagem2.png}
    \caption{Uso offline no Drive}
\end{figure}
