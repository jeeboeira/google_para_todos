...
\begin{figure}[H]
    ...
    \caption{Menu aberto da opção “Inserir” com destaque no subitem “Imagem”}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Imagem do logo do IFRS Campus Farroupilha selecionado pelo usuário, são visíveis os quadrados de ajuste do tamanho da imagem}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Menu que aparece ao clicar com o botão direito na imagem}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Painel lateral com configurações de ““Opções de imagem”, uma seta destaca a conexão entre a imagem e o painel lateral}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Menu aberto da sequência de opções selecionadas: “Inserir” e “Tabela”}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Tabela vazia de exemplo com duas setas indicando a localização dos menu da esquerda e superior}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Menu com configurações da tabela. Existe um destaque desde a opção “Inserir linha do título” até a “Opções de tabela”}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Menu lateral com as configurações do subitem “Opções da tabela”, uma seta indica a conexão entre a tabela e o menu}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{images/documentos/menu_inserir/pt2/Imagem1.png}
    \caption{Abrir documento original}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Pré-visualização da importação do gráfico}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{images/documentos/menu_inserir/pt2/Imagem3.png}
    \caption{Realizar a atualização do gráfico}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{images/documentos/menu_inserir/pt2/Imagem4.png}
    \caption{Menu de posicionamento do gráfico}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{images/documentos/menu_inserir/pt2/Imagem5.png}
    \caption{Mudança de cores do gráfico}
\end{figure}
