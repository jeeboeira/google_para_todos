...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem1.png}
    \caption{Adicionar evento no calendário}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem3.png}
    \caption{Opções de repetição do evento}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem4.png}
    \caption{Recorrência personalizada do evento}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem5.png}
    \caption{Convidados do evento}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem6.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem7.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem8.png}
    \caption{Disponibilidade dos participantes}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem9.png}
    \caption{Mais opções}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem10.png}
    \caption{Aba de opções avançadas do evento}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem11.png}
    \caption{Salvar evento}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem12.png}
    \caption{Salavr evento}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem13.png}
    \caption{Covites por email}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem14.png}
    \caption{Adicionar tarefa no calendário}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem15.png}
    \caption{Opões da tarefa}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem16.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem17.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem18.png}
    \caption{Disponibilidade geral}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem19.png}
    \caption{Salvra grade de agendamento}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem20.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem21.png}
    \caption{Opções de ausência}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem22.png}
    \caption{Recusar reuniões automaticamente}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem23.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem24.png}
    \caption{Informações de ausência}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem25.png}
    \caption{Ausência no calendário}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem26.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem27.png}
    \caption{Salvar local de trabalho}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem28.png}
    \caption{Ver local de trabalho}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem29.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem30.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem31.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem32.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario_pt_II/Imagem0.png}
    \caption{Modos de visualização}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_entradas_no_calendario/Imagem17.png}
    \caption{Pesquisa no Google Agenda}
\end{figure}
