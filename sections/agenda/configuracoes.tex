...
\begin{figure}[H]
    ...
    \caption{Canto superior direito da tela do Google Agenda}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Botão de Configurações}
\end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{images/agenda/configuracoes/Imagem3.png}
        \caption{Idioma e Região no Google Agenda}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem4.png}
        \caption{Ajuste de fuso horário}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem5.png}
        \caption{Configuração de eventos}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem6.png}
        \caption{Configurações de notificação}
    \end{figure}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem7.png}
        \caption{Opções de visualização}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem8.png}
        \caption{Recursos inteligentes do Google Workspace}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem9.png}
        \caption{Horário e local de trabalho}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem10.png}
        \caption{Ativar atalhos do teclado}
    \end{figure}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem11.png}
        \caption{Se inscrever em uma agenda}
    \end{figure}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem12.png}
        \caption{Criar nova agenda}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem13.png}
        \caption{Procurar agendas}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem14.png}
        \caption{Adicionar agenda por link}
    \end{figure}
\end{enumerate}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.8\textwidth]{/agenda/configuracoes/Imagem15.png}
        \caption{Importar e exportar agendas}
    \end{figure}
\end{enumerate}
