...
\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{images/agenda/configuracoes/Imagem_1.png}
    \caption{}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.39\textwidth]{images/agenda/configuracoes/Imagem_2.png}
    \caption{}
\end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.39\textwidth]{images/agenda/configuracoes/Imagem_03.png}
        \caption{}
    \end{figure}
