...
\begin{itemize}
    ...
    \item \textbf{Imprimir}: permite gerar e salvar um arquivo PDF ou realizar a impressão de um intervalo de tempo da agenda;
    \item \textbf{Instalar complemento}: permite integrar ao Google Agenda aplicativos de terceiros para melhorar a experiência do usuário.
\end{itemize}
...
\begin{enumerate}
    ...
    \item \textbf{Recursos inteligentes do Google Workspace}: personaliza a experiência do
     usuário com recursos de outros produtos do Google, apps como o Gmail, Agenda, Chat, Meet e Drive. 
    ...
    \item \textbf{Offline}: permite utilizar da agenda principal mesmo quando estiver sem internet, dando acesso ao 
...
\begin{enumerate}
    ...
    \item \textbf{Do URL}\@: permite adicionar uma agenda externa utilizando um endereço de URL, integrando calendários de outras plataformas;
...
\begin{enumerate}
    \item \textbf{Importar}: permite importar eventos através de um arquivo no formato .ics para dentro do Google Agenda; %chktex 26
    \item \textbf{Exportar}: permite baixar os seus eventos do Google agenda em um arquivo .zip que contém um ou mais arquivos no formato .ics. %chktex 26
