...
\begin{enumerate}
    \item Importar:Permite trazer eventos através de um arquivo no formato .ics para dentro do Google Agenda. %chktex 26
    \item Exportar: Permite baixar os seus eventos do Google agenda em um arquivo .zip que contém um ou mais arquivos no formato .ics. %chktex 26
