...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_de_multiplas_agendas/Imagem1.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_de_multiplas_agendas/Imagem2.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_de_multiplas_agendas/Imagem3.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_de_multiplas_agendas/Imagem4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_de_multiplas_agendas/Imagem5.png}
    \caption{Tela de importação/exportação de agendas com um \gls{arquivo} com eventos prestes a serem importados}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_de_multiplas_agendas/Imagem6.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_de_multiplas_agendas/Imagem7.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/agenda/gerenciamento_de_multiplas_agendas/Imagem8.png}
