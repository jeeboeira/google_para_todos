...
\chapter{Modelo de Capítulo — Lorem Ipsum}\label{chap:lorem}
...
\begin{passos}
\begin{enumerate}
  \item Acesse o sistema e faça \gls{login}.
...
\begin{figure}[!ht]
  ...
  \caption{Área reservada para imagem de exemplo.}\label{fig:exemplo}
\end{figure}
...
\bottomrule
\end{tabular}
\caption{Tabela de exemplo com \texttt{booktabs}.}\label{tab:exemplo}
\end{table}
...
\begin{itemize}
  \item \tecla{Ctrl+K} → inserir \gls{link};
...
\textbf{\Gls{arquivo} muito grande:} compacte ou use \gls{upload} via aplicativo de \gls{desktop}.\\
