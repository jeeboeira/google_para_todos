...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/gmail/exclusao_reg_leitura_adiar/Imagem1.png}
    \caption{Captura de tela com destaque para a caixa de seleção de mensagem e o ícone de lixeira}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.7\textwidth]{/gmail/exclusao_reg_leitura_adiar/Imagem2.png}
    \caption{Captura de tela com destaque para o ícone de lixeira na mensagem aberta}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/gmail/exclusao_reg_leitura_adiar/Imagem3.png}
    \caption{Captura de tela com destaque para a caixa de seleção e o ícone ``Mover para''}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/gmail/exclusao_reg_leitura_adiar/Imagem4.png}
    \caption{Captura de tela com destaque para a caixa de seleção e o botão ``Excluir definitivamente''}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/gmail/exclusao_reg_leitura_adiar/Imagem5.png}
    \caption{Captura de tela com destaque para o botão ``Esvaziar a lixeira agora''}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/gmail/exclusao_reg_leitura_adiar/Imagem6.png}
    \caption{Captura de tela com destaque para o ícone de ``Marcar como lida''}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/gmail/exclusao_reg_leitura_adiar/Imagem7.png}
    \caption{Captura de tela com destaque para o ícone de relógio (``Adiar email'')}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/gmail/exclusao_reg_leitura_adiar/Imagem8.png}
    \caption{Captura de tela com destaque para a janela de opções para adiar o e-mail}
\end{figure}