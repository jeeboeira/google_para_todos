...
\begin{itemize}
    ...
    \item Fóruns: corresponde aos e-mails com mensagens de grupos \gls{online}, fóruns 
...
encontrar seus e-mails de maior relevância.
...
Para gerenciar os marcadores, você pode ir até a \gls{aba} esquerda do “Menu 
Principal” e selecionar a opção “Mais”.\newline

Em seguida, selecione a opção "Gerenciar Marcadores".
...
\begin{itemize}
    ...
    procurados.
    \item “Tamanho” --- Com este filtro você encontra e-mails por espaço de 
...
\begin{itemize}
    \item “Ignorar a caixa de entrada (arquivar)” --- Os e-mails irão diretamente 
    ...
    \item “Encaminhar” --- Você poderá adicionar um e-mail para que os 
        respectivos e-mails filtrados sejam encaminhados automaticamente.
    \item “Excluir” --- Os e-mails buscados serão excluídos automaticamente.
    \item “Nunca enviar para \Gls{spam}” --- Os e-mails não serão atribuídos a \gls{aba} 
        “\Gls{spam}”.
    \item “Sempre marcar como importante” --- Irá marcá-los automaticamente como 
        “importante”.
    \item “Nunca marcar como importante” --- Os e-mails em questão não serão 
