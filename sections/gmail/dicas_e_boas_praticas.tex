...
\begin{itemize}
    ...
    mil mensagens por vez (\cite{GoogleWorkspacePraticasRecomendadas2025}).
    ...
    e encaminhar para outra conta. Isso torna seu uso mais eficiente (\cite{GoogleWorkspacePraticasRecomendadas2025}).
    ...
    ajudando a manter a caixa de entrada mais limpa (\cite{GoogleWorkspacePraticasRecomendadas2025}).
    \item O Gmail permite que o usuário gerencie \textbf{várias contas em um único lugar}, podendo 
    alternar entre elas sem a necessidade de sair e entrar novamente (\cite{GoogleWorkspacePraticasRecomendadas2025}).
    ...
    economizar tempo e padronizar a comunicação (\cite{GoogleWorkspacePraticasRecomendadas2025}).
    \item Para manter sua conta segura é recomendável aplicar a \textbf{autenticação em duas 
    etapas}, adicionando mais uma camada de proteção no \gls{login} (\cite{GoogleWorkspacePraticasRecomendadas2025}).
    ...
    remetentes desconhecidos sem verificar a autenticidade (\cite{GoogleWorkspacePraticasRecomendadas2025}).
    \item O Gmail permite configurar \textbf{assinaturas personalizadas}, que são inseridas ao 
    final do e-mail enviado, tornando suas mensagens mais profissionais (\cite{GoogleWorkspacePraticasRecomendadas2025}).
    ...
    reuniões, prazos e lembretes sem sair da caixa de entrada (\cite{GoogleWorkspacePraticasRecomendadas2025}).
\end{itemize}
...
mensagens e navegar entre diferentes seções (\cite{GmailAjudaOrganizarMarcadores2025}).\newline
