...
\begin{figure}[H]
    \centering
    \includegraphics[width=.7\textwidth]{/gmail/responder_encaminhar_marcar_emails/Imagem1.png}
    \caption{Captura de tela com destaque para a caixa de resposta a uma mensagem no Gmail}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.7\textwidth]{/gmail/responder_encaminhar_marcar_emails/Imagem2.png}
    \caption{Captura de tela com destaque para o botão de encaminhar mensagem no Gmail}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/gmail/responder_encaminhar_marcar_emails/Imagem3.png}
    \caption{Captura de tela com destaque para a opção ``Marcar como importante''}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/gmail/responder_encaminhar_marcar_emails/Imagem4.png}
    \caption{Captura de tela com destaque para a opção ``Marcar como não importante''}
\end{figure}


\section{Como Lidar com E-mails de \Gls{spam}}
\subsubsection{O que é \Gls{spam}?}
\Gls{spam} são e-mails indesejados, geralmente enviados em massa para um grande número 
...
(\gls{phishing}), vírus ou links maliciosos. Nunca clique em links ou baixe anexos de 
e-mails de \gls{spam}.


\subsubsection{Como Marcar um E-mail como \Gls{spam} (Denunciar \Gls{spam})}
Ao receber um e-mail de \gls{spam} em sua caixa de entrada, você pode denunciá-lo para 
...
\begin{figure}[H]
    \centering
    \includegraphics[width=.8\textwidth]{/gmail/responder_encaminhar_marcar_emails/Imagem5.png}
    \caption{Captura de tela com destaque para o ícone de denunciar \gls{spam} no Gmail}
\end{figure}


\subsubsection{Como Acessar e Gerenciar a Caixa de \Gls{spam}}
Como um e-mail legítimo pode ser classificado como \gls{spam} por engano, é uma boa 
prática verificar esta pasta periodicamente. Para acessá-la, clique na pasta "\Gls{spam}" no menu 
lateral esquerdo. Caso encontre um e-mail que não é \gls{spam}, basta selecioná-lo e 
clicar no botão "Não é \gls{spam}" no topo da tela para que ele retorne à sua Caixa de 
Entrada.

\begin{figure}[H]
    \centering
    \includegraphics[width=.9\textwidth]{/gmail/responder_encaminhar_marcar_emails/Imagem6.png}
    \caption{Captura de tela com destaque para o botão ``Não é \gls{spam}'' no Gmail}
\end{figure}