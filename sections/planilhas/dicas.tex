...
\begin{itemize}
	...
	\item \textbf{Páginas:} Renomeie sempre as páginas com nomes curtos e descritivos que indiquem o seu conteúdo, como "Dados Brutos", "\gls{dashboard}", "Resumo Mensal" ou "Instruções".
\end{itemize}
