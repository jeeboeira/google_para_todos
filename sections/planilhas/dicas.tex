...
\subsection{Nomeação de arquivos clara e consistente}
...
\begin{itemize}
	\item \textbf{Arquivos:} Adote um padrão de nomeação consistente para os arquivos que inclua informações relevantes como o conteúdo, a área responsável e a data (ex: Relatorio-Vendas\_Marketing\_2025-10). É recomendado também evitar o uso de espaços nos nomes dos arquivos para garantir uma melhor compatibilidade durante a exportação para outros formatos.   
	\item \textbf{Páginas:} Renomeie sempre as abas com nomes curtos e descritivos que indiquem o seu conteúdo, como "Dados Brutos", "Dashboard", "Resumo Mensal" ou "Instruções".
\end{itemize}
...
\begin{figure}[h]
	...
	\caption{Menu de Pintar Formatação}
