...
\section{Introdução}
Uma das ferramentas mais poderosas e conhecidas dentro do \textbf{\Gls{workspace}}, é o \textbf{Google Planilhas} (conhecido também como \textbf{Google Sheets}). Seja para organizar as finanças pessoais, gerenciar um projeto da faculdade ou analisar dados de um negócio, ele se torna um grande aliado. Nesta seção, será introduzida a ferramenta, juntamente com suas funcionalidades.

\subsection{O que é?}
De maneira simples, uma planilha é um documento composto por linhas e colunas de células. Nessas células é possível inserir textos, números e fórmulas que permitem fazer cálculos, análises e etc.

O Google Planilhas é uma alternativa \gls{online} e gratuita ao Microsoft Excel, ferramenta que possui ampla base de usuários de longa data. Ele funciona diretamente no navegador, não sendo necessário instalar (o que pode ser uma vantagem em relação ao Excel) e além disso, permite integração com outras ferramentas do \Gls{workspace}, como o Google Drive e o Google Forms.
...
Se já tens conhecimento da ferramenta \textbf{Google Drive}, que também é elucidada aqui, é interessante que crie seus documentos a partir de lá, pois assim podem ser organizados ao seu diretório pessoal em \gls{nuvem}, junto aos seus outros documentos. Nada o impede de importá-lo ao seu diretório posteriormente, caso opte por criar o \gls{arquivo} diretamente no site da ferramenta.

\begin{itemize}
	\item Google Drive (\href{https://drive.google.com/}{drive.google.com}): Acesse ou crie o diretório que deseja hospedar o \gls{arquivo} e no canto superior esquerdo vá no botão “Novo” > “Planilhas Google”.
	...
	\item Bônus: Na barra de endereços do seu navegador em uma nova guia, apenas escreva “\href{https://sheet.new/}{sheet.new}”. Esse \gls{link} te leva para uma planilha nova rapidamente!
\end{itemize}

Antes de trabalhar com a planilha e os dados em si, vamos primeiramente renomear o \gls{arquivo}, para facilitar a organização: vá ao canto superior esquerdo e onde está o nome do \gls{arquivo}, que por padrão é “Planilha sem título”, e simplesmente dê um clique único com o botão esquerdo do mouse e assim, pode reescrevê-lo com o que desejar.
...
\begin{dica}
	Evite usar espaços no nome do \gls{arquivo}, para garantir uma melhor compatibilidade com a eventual exportação do \gls{arquivo}.
\end{dica}
