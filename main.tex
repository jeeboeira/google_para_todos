...
\titleformat{\section}[hang]{\Large\bfseries\color{primary}}{\thesection}{0.6em}{\raggedright}{}
% Ensure subsection titles are left-aligned (prevent full justification)
\titleformat{\subsection}[hang]{\large\bfseries\color{ggray}}{\thesubsection}{0.6em}{\raggedright}{}
\titleformat{\subsubsection}[hang]{\bfseries}{\thesubsubsection}{0.6em}{}
